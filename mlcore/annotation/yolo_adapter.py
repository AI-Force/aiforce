...
__all__ = ['FIELD_NAMES', 'DEFAULT_CATEGORIES_FILE', 'logger', 'YOLOAdapter']
...
class YOLOAdapter(AnnotationAdapter):
    ...
    def __init__(self, args):
        ...
        if args.categories_file is None:
            self.categories_file = join(dirname(dirname(self.files_path.rstrip(os.sep))), DEFAULT_CATEGORIES_FILE)
        else:
    ...
    def argparse(cls, prefix=None):
        ...
        parser.add_argument(cls.assign_prefix('--files_path', prefix),
                            ...
                            required=True)
        parser.add_argument(cls.assign_prefix('--annotations_path', prefix),
