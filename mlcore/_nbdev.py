...
index = {"DEFAULT_ANNOTATIONS_FILE": "via-converter.ipynb",
         "DEFAULT_CATEGORY_LABEL_KEY": "annotation-via.ipynb",
         "logger": "via-converter.ipynb",
         ...
         "configure_logging": "via-converter.ipynb",
         ...
         "region_rect_to_polygon": "via-converter.ipynb",
         "region_polygon_to_rect": "via-converter.ipynb"}
