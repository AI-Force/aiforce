...
index = {"RegionShape": "annotation-core.ipynb",
         ...
         "FolderCategoryAdapter": "annotation-folder_category_adapter.ipynb",
         "configure_logging": "tools-image_size_calculator.ipynb",
         "DEFAULT_ANNOTATIONS_FILE": "annotation-via_adapter.ipynb",
         "MultiCategoryAdapter": "annotation-multi_category_adapter.ipynb",
         "DEFAULT_CATEGORY_ID": "annotation-via_adapter.ipynb",
         "CSV_FIELDNAMES": "annotation-via_adapter.ipynb",
         "read_annotations": "annotation-yolo_adapter.ipynb",
         "write_annotations": "annotation-yolo_adapter.ipynb",
         "show_annotated_images": "annotation-viewer.ipynb",
         "FIELD_NAMES": "annotation-yolo_adapter.ipynb",
         "DEFAULT_CATEGORIES_FILE": "dataset-image_segmentation.ipynb",
         "NOT_CATEGORIZED": "dataset-image_segmentation.ipynb",
         "BACKGROUND_CLASS": "category_tools.ipynb",
         "BACKGROUND_CLASS_CODE": "category_tools.ipynb",
         "read_categories": "category_tools.ipynb",
         "DEFAULT_SPLIT": "dataset_generator.ipynb",
         "TRAIN_VAL_FOLDER": "dataset-image_segmentation.ipynb",
         "TRAIN_FOLDER": "dataset-image_segmentation.ipynb",
         "VAL_FOLDER": "dataset-image_segmentation.ipynb",
         "TEST_FOLDER": "dataset-image_segmentation.ipynb",
         "Dataset": "dataset-core.ipynb",
         "split_train_val_data": "dataset-core.ipynb",
         "copy_image_and_assign_orientation": "dataset-core.ipynb",
         "input_feedback": "dataset-core.ipynb",
         "DEFAULT_CLASSIFICATION_ANNOTATIONS_FILE": "dataset-image_segmentation.ipynb",
         "DATA_SET_FOLDER": "dataset-image_segmentation.ipynb",
         "DATASET_TYPE": "dataset-image_segmentation.ipynb",
         "ImageClassificationDataset": "dataset-image_classification.ipynb",
         "build_dataset": "dataset_generator.ipynb",
         "CATEGORY_LABEL_KEY": "dataset_generator.ipynb",
         "DEFAULT_SEGMENTATION_ANNOTATIONS_FILE": "dataset-image_segmentation.ipynb",
         "SEMANTIC_MASK_FOLDER": "dataset-image_segmentation.ipynb",
