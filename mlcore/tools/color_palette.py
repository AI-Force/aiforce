...
__all__ = ['pascal_voc_palette', 'ade20k_palette', 'cityscapes_palette', 'mhp_palette']

# Cell


def pascal_voc_palette(num_cls=256):
    """
...
def mhp_palette(version=1.0):
    """
    Generates the Multi-Human Parsing (MHP) data-set color palette.
    Data-Set URL:
    ...
    `version`: the version of the data-set to generate the colors for
    return: the generated color palette
    """
    palette = []
    if version == 1.0:
