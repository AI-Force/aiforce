...
__all__ = ['DEFAULT_ANNOTATIONS_FILE', 'DEFAULT_CATEGORY_LABEL_KEY', 'CSV_FIELDNAMES_V1', 'CSV_FIELDNAMES_V2',
           'JSON_FIELDNAMES_V2', 'JSON_FIELDNAMES_V1', 'logger', 'VIAAnnotationAdapter']
